IETF Network Management Agent Side Meeting
On Wednesday Morning, Network Management Agent Observability, Intervention and Control Side meeting has been organized, more than 50+ people participate in Side meeting. The participants include proponents from Huawei, Cisco, Ciena, Nokia, Telefonica, Swisscom, CMCC etc.
The main focused use cases are network operation use cases such as fault management, anomaly detection, with single agent management, multi-agent coordination, all these agents are scenario specific.
...
b. Agent intervention and Control are intent face related, needs to break down into several category capabilities, such readonly, writeaccess, 
beyond control or start from function integrity and then function quality
...
intent angles and fill the gap on agent observability, e.g., common schema and information model.
Also we heard some request where this discussion should be continued.mailing list?
